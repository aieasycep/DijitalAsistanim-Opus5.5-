 ...
 * `EmptyDatabase` keeps PostgREST untyped calls impossible until the generated `Database` type
 * (`@da/api-client` `database.types.ts`, T-2.25) replaces it.
 */
...
export type AppSupabaseClient = SupabaseClient<EmptyDatabase>;
...
export function getSupabase(): AppSupabaseClient {
  if (client === undefined) {
    ...
    client = createSupabaseClient<EmptyDatabase>({
